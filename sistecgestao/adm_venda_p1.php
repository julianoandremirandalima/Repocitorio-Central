...
<!-- End Header -->
  ...
  <main id="main">
    ...
    <section id="services">
      ...
      <div class="container">
        <div class="form">
          <form action="adm_venda_p2.php" method="post">
            <div class="row">
            <div align="center">
                <div class="col-lg-3">
           ...
           <br>
            ...
            <div class="text-center"><button type="submit" class="btn btn-primary">PROSSEGUIR <i class="bi bi-arrow-right-circle"></i></button>
              <input name="loja" type="hidden" id="loja" value="<?=$loja?>">
            </div>
          </form>
        </div>
