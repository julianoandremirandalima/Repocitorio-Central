	...
	if($_POST["operacao"] == "Add")
	{
		...
		if(!empty($resultado))
		{
			...
			*/
			...
			$message .= "Acesse o link https://sindservasistema.com.br<br> <strong>Usuário:</strong> $usuario <br> <strong>Senha:</strong> 123456 <br> Clique em <strong>CONTRATO</strong> e tenha acesso ao contrato de parceria com o SindServa.<br> Qualquer dúvida entre em contato! <br> (35) 3260-2034";
