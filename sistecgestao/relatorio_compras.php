...
<!-- End Header -->
  ...
  <div class="col-auto">
    <button type="submit" class="btn btn-primary" name="filtrar" value="sim">Filtrar</button>
	  ...
	  <a href="relatorio_compras_imprimir.php?ano=<?=$ano?>&mes=<?=$mes?>&idusuario=<?=$idcolaboradorlogado?>&nome=<?=$NOMELOGADO?>" target="_blank" class="btn btn-warning">Imprimir</a>
  </div>
</form>
        ...
        <tbody>
				...
				<tr id="<?php echo $row["id"]; ?>">
					...
					<td><?php echo $row["cnpjLogista"]; ?></td>   
