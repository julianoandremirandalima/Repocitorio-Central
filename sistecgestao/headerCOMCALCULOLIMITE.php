...
*/
  ...
  rg = '$rg', salario = '$salario', limite = '$limitecalculo', cartao = 'sim'
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
       <a href="#" data-bs-toggle="modal" data-bs-target="#modalcontato">
        <i class="bi bi-telephone-fill d-flex align-items-center ms-4"><span><?=$arrayfixa["atendimento"]?></span></i>
		  </a>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo" class="divhorizontal">
        <h1><a href="principal.php"><img src="logohorizontal.png" width="220" height="50"></a></h1>
...
<div class="modal fade" id="trocaPerfil" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-12" style="display:<?=$mostrarsalario?>">
    ...
    <input type="number" min="0.00" max="100000.00" step="0.01" class="form-control moeda" id="salariox" name="salario" value="<?=$arraycolaborador['salario']?>" style="background-color: #ffca2c;">
  </div>
