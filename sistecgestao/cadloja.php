      ...
      <div class="modal-body">
        ...
        <label><strong>Nome de Usuário no sistema</strong></label>
          ...
          <label>Telefone</label>
					<input type="text" name="telefoneLogista" id="telefoneLogista" class="form-control"/>
					<br />
          <label>Email</label>
          ...
          <br />
					<label>Conveniada?</label>
					<select id="conveniada" name="conveniada" class="form-select">
								<option selected>Selecione</option>
								<option value="conveniada">sim</option>
