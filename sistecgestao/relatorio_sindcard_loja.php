...
<!-- End Header -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12">
            <div class="box">
              ...
              <p class="description">Agrupados Por Empresas</p>
              <hr>
			  <p id="success"></p>
  ...
  <div class="col-auto" style="display: <?=$mostrardiv?>;"> 
    ...
    <a href="relatorio_sindcard_loja.php?mes=<?=$mes?>&ano=<?=$ano?>&filtrar=sim" class="btn btn-success">Por Empresas</a>
  ...
  <a  href="relatorio_sindcard_loja_excel.php?mes=<?=$mes?>&ano=<?=$ano?>&filtrar=sim" target="_blanck"> <button type="button" class="btn btn-warning btn-sm" >
        ...
        <tr>
            ...
            <th width="40%">LOJA</th>
                        ...
                        <th width="30%" style="text-align: right">VALOR A PAGAR COM DESCONTO</th>
        ...
        <tbody>
          ...
          <td><?php echo $row["nomeLogista"]; ?></td>
					...
					<td align="right">R$ <?php echo number_format($row["total"],2,",","."); ?> (-<?=$descontoporloja?>)%</td>
