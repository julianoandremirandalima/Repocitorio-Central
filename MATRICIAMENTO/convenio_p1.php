...
<!-- End Header -->
  ...
  <main id="main">
    ...
    <section id="services">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <h4 class="title">ADMINISTRAR CONVÊNIOS</h4>
              <p class="description">Identifique qual convênio abaixo.</p>
              <hr>
      ...
      <div class="container">
        <div class="form">
          <form action="convenio_p2.php" method="post">
            <div class="row">
            <div align="center">
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
						...
						<?php
							$selectConv = $con->prepare("SELECT * FROM lojas WHERE conveniada = 'conveniada' ORDER BY nomeLogista");
							$selectConv->execute();
