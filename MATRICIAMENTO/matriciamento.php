...
<form action="matriciamento.php" method="post">
<!-- Modal -->
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
													   ...
													   else
													   {
															...
															$query = "SELECT * FROM $tabela WHERE status = 'NOVO' AND idprofissional = '$usuariologado'";
													   }
																  ...
																  <td><?=$array["nomepaciente"]?></td>
																   <td><?=$array["obs"]?></td>
																    <td><?=$array["planoterapeutico"]?></td>
																	 ...
																	 <td><?=$array["status"]?><br><a href="matriciamento-editar.php?pagina=matriciamento.php&id=<?=$array["id"]?>"><button class="btn btn-warning btn-icon"><i class="fa fa-pencil"></i></button></a>
