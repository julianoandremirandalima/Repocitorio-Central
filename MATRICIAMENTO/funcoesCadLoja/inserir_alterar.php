...
if(isset($_POST["operacao"]))
{
	if($_POST["operacao"] == "Add")
	{
		...
		$statement = $con->prepare("
			INSERT INTO lojas (nomeLogista, usuarioLogista, cnpjLogista, enderecoLogista, telefoneLogista, emailLogista, statusLogista, razaosocialLogista, imagem, descontologista, responsavelLogista, cpfresponsavelLogista, dataLogista, conveniada) 
			VALUES (:nome, :usuario, :cnpj, :endereco, :telefone, :email, :status, :razao, :imagem, :desconto, :responsavelLogista, :cpfresponsavelLogista, :dataLogista, :conveniada)
		");
		...
		$resultado = $statement->execute(
			array(
				...
				':conveniada' => $_REQUEST["conveniada"]
