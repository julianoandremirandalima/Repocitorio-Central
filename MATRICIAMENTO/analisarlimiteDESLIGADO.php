...
<?=number_format($arraycolaborador["limite"],2,",",".")?>
              ...
              <label for="textfield" style="display: <?=$esconde?>"> + Parcela do mês <?=$mesatual?>: R$</label> 
              
              <input name="valormes" type="text" id="textfield" size="5" value="<?=number_format($total,2,".","")?>" style="background: #DC0003; color: #FFFFFF; display: <?=$esconde?>">
              <input type="submit" name="submit" id="submit" value="Enviar" style="display: <?=$esconde?>">
