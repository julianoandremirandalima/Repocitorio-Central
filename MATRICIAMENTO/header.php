...
else if($tipologado=="gestor")
{
  $menu = 'menugestor.php';
  $conteudoprincipal = "conteudogestor.php";
  $mostrar = "none";
}
else if($tipologado=="colaborador")
{
...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
  ...
  * License: https://bootstrapmade.com/license/
  ...
  .divhorizontal{
	  background:#fff;
	  /*transform: skewX(-20deg); FAZ FICAR INCLINADO*/
	  padding: .9rem;
...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="d-flex align-items-center" style="background-color:#003366">
    <div class="container d-flex justify-content-between">

      <div id="logo" class="divhorizontal" style="background-color:#0099FF; border-radius:0px 20px 0px 20px; padding:30px 20px 30px 20px"> 
        <h1><a href="principal.php"> <img src="logosistec.png" width="100"> <img src="logoAPS.png" height="50"></a></h1>
