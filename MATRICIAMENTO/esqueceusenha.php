...
<div class="container">
 <div class="circle" style="background-color:#fff">
 	<form action="esqueceusenhaverificar.php" method="post">
    <div align="center" class="rotated">
     ...
     <p class="sigle-title">RECUPERAR SENHA DO SISTEMA </p>
     <?=$erro?>
     <input type="text" class="user" placeholder="DIGITE SEU EMAIL" name="usuario" required>
     
    
     <input type="hidden" name="btesqueceusenha" value="sim">
