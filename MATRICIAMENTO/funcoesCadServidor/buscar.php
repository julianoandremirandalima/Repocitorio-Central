...
$query .= "SELECT * FROM colaboradores ";
	...
	foreach($resultado as $row)
	{
		...
		if($assinatura=="LGPD")
		{
			$corbt = "<a href='LGPDaceita.php?idtitular=$idbdx&nome=$nomebdx' target=_blanck>LGPD</a>";
		}
		else
		{
			$corbt = "";
		...
		{
			$corbtc = "<a href='CONTRATOaceito.php?idtitular=$idbdx&nome=$nomebdx' target=_blanck>assinado</a>";
		}
		else
		{
			$corbtc = "";
