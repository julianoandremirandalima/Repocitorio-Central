        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12">
            <div class="box">
              ...
              <h4 class="title">MATRICIAMENTOS EM ANDAMENTO</h4>
                                                ...
                                                <table id="example" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
													   ...
													   else
													   {
															...
															$query = "SELECT * FROM $tabela WHERE status = 'EM ANDAMENTO' AND idprofissional = '$usuariologado'";
													   }
																  ...
																  <td><?=$array["nomepaciente"]?></td>
																   <td><?=$array["obs"]?></td>
																    <td><?=$array["planoterapeutico"]?></td>
																	 ...
																	 <td><?=$array["status"]?><br><a href="matriciamento-editar.php?pagina=matriciamento-em-andamento.php&id=<?=$array["id"]?>"><button class="btn btn-primary btn-icon"><i class="fa fa-pencil"></i></button></a>
															<form action="matriciamento.php" method="post" onsubmit="return confirmar();" style="display:<?=$escondebt?>"><button class="btn btn-danger btn-icon"><i class="fa fa-trash"></i></button><input type="hidden" class="form-control" name="id" value="<?=$array["id"]?>">
