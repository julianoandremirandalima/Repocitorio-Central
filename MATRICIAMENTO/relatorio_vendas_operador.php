  ...
  <div class="col-auto">
    <button type="submit" class="btn btn-primary" name="filtrar" value="sim">Filtrar</button>
        ...
        <tbody>
                ...
                $result = $con->prepare("SELECT SUM(valorparcela) AS total, colaboradores.matricula, colaboradores.nome, vendas.datarealvenda, chave_venda, numeroparcela, quantasparcelas FROM vendas
                INNER JOIN colaboradores ON vendas.id_usuario = colaboradores.id
                WHERE id_loja = '$idLogista' AND mes_venda = '$mes' AND ano_venda = '$ano'  AND quemvendeu = '$iduserlogistalogado'
