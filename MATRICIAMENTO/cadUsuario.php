        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <p class="description">Lista dos colaboradores cadastrados no sistema.</p>
              <hr>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="row">
			<input style="font-size: 12px;" type="hidden" name="usuariologado" class="form-control" id="nomeuserxxx" value="<?=$nomelogadox?>">
			<input style="font-size: 12px;" type="hidden" name="idusuariologado" class="form-control" id="iduserxxx" value="<?=$idcolaboradorlogado?>">
						...
						<div class="row">
							...
							<label>LIMITE DO CARTÃO (R$)</label>
								...
								<input style="font-size: 12px;" type="number" step="any" min="0"  name="limite" class="form-control" id="limite" style="background-color: #066; color: #fff" readonly>
							...
							<div class="form-group col-md-6 mt-6 mt-md-0">
							<label>NOVO LIMITE DO CARTÃO (R$) - Use com bom senso!</label>
											
								<input style="font-size: 12px; background:#C4ED09" type="number" step="any" min="0"  name="novolimite" class="form-control" id="novolimite" style="background-color: #066; color: #fff" <?=$bloqueiaoperador?>>
  ...
  include("footer.php");
  ?>
<script src="funcoesCadUsuario/funcaoMestra.js"></script>
